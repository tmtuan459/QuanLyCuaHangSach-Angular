...
@Entity
@Table(name = "DetailPN")
public class ImportDetailpEntity {
...
//	@JsonIgnore
	...
	private ImportEntity phieuNhap;
	

    @OneToOne
	@JoinColumn(name = "maSach_id")
	private BookEntity maSach;
	...
	public ImportEntity getPhieuNhap() {
		return phieuNhap;
	}


	public void setPhieuNhap(ImportEntity phieuNhap) {
		this.phieuNhap = phieuNhap;
	}


	public BookEntity getMaSach() {
		return maSach;
	}


	public void setMaSach(BookEntity maSach) {
		this.maSach = maSach;
	}
