...
public class ThongKeController {
	...
	@Autowired
	private ChiTietPhieuXuatRepository ctpxrepository;
	...
	public ResponseEntity<Object> listAll() {
		try {
			return ResponseEntity.ok(ctpxrepository.ListPhieuXuat());
	...
	public ResponseEntity<Object> listRevenueByBook() {
		try {
			return ResponseEntity.ok(ctpxrepository.ListDoanhThuTheoSach());
		} catch (NullPointerException e) {
			return ResponseEntity.ok(new MessageRespone("Sorry, we have an error! Please login and try again"));
		}
	}
